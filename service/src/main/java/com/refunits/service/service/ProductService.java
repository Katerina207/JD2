...
public class ProductService {
    ...
    public void addProduct(String login, Product product) {
        product.setNumber(1);
        product.setSum((product.getSelectedOptions() != null ? sum(product.getSelectedOptions().stream()
        ...
        return products.stream()
                .map(prod -> ViewProduct.builder()
                        ...
                        .unit(ViewBasicUnitInfo.builder()
                                ...
                                .build())
                        .options(prod.getSelectedOptions() != null ? prod.getSelectedOptions().stream()
